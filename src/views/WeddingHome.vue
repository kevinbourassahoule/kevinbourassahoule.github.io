...
{
  "en": {
    "gettingMarried": "<span class=''>SARAH and KEVIN</span><br />are getting married {duration}, on<br />{date}."
  },
  "fr": {
...
<template>
  <div class="flex items-center justify-center mt-20 sm:mt-2 md:mt-8 xl:mt-20">
    <div
